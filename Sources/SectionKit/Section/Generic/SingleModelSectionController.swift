...
/**
 A `SectionController` that displays data of a single model.
 ...
 it is recommended to use `ListSectionController` or another subclass inheriting from `ListSectionController` instead.
 */
