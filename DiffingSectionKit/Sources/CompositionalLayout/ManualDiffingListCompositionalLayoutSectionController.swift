...
@MainActor
@available(iOS 13.0, *)
open class ManualDiffingListCompositionalLayoutSectionController<
    Model,
    Item
...
@available(iOS 13.0, *)
extension ManualDiffingListCompositionalLayoutSectionController where Item: Equatable {
    /**
     Initialise an instance of `ManualDiffingListSectionController`.
...
extension ManualDiffingListCompositionalLayoutSectionController where Item: Identifiable {
    /**
     Initialise an instance of `ManualDiffingListSectionController`.
 ...
 */
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
extension ManualDiffingListCompositionalLayoutSectionController where Item: Identifiable & Equatable {
    /**
     Initialise an instance of `ManualDiffingListSectionController`.
