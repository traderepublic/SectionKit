...
extension Sequence {
    /// Filter out duplicate elements according to a key returned by the `selector` closure. The
    /// order is preserved and, in case of a duplicate, the first element of that key is matched.
