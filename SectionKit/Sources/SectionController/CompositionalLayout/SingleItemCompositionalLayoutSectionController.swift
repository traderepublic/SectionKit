...
@MainActor
@available(iOS 13.0, *)
open class SingleItemCompositionalLayoutSectionController<Model, Item>: BaseCompositionalLayoutSectionController {
...
@available(iOS 13.0, *)
extension SingleItemCompositionalLayoutSectionController where Item: Equatable {
    /**
     Initialise an instance of `SingleItemSectionController`
